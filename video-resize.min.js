(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VideoResize"] = factory();
	else
		root["VideoResize"] = factory();
})(this, function() {
...
var DisplaySize = function (_BaseModule) {
  ...
  function DisplaySize() {
    ...
    return _possibleConstructorReturn(this, (DisplaySize.__proto__ || Object.getPrototypeOf(DisplaySize)).apply(this, arguments));
  }
  ...
  _createClass(DisplaySize, [{
    ...
    value: function onUpdate() {
      ...
      if (size[0] > 120 && size[1] > 30) {
        ...
        var _dispRect = this.display.getBoundingClientRect();
        Object.assign(this.display.style, {
  ...
  _createClass(Resize, [{
    ...
    value: function onCreate() {
      ...
      this.handleDrag = function (evt) {
        ...
        var deltaY = evt.clientY - _this2.dragStartY;
        if (_this2.dragBox === _this2.boxes[0] || _this2.dragBox === _this2.boxes[3]) {
          _this2.vid.width = Math.round(_this2.preDragWidth - deltaX);
          _this2.vid.height = Math.round(_this2.preDragHeight - deltaY);
        } else {
          _this2.vid.width = Math.round(_this2.preDragWidth + deltaX);
          _this2.vid.height = Math.round(_this2.preDragHeight + deltaY);
        }
    ...
    key: 'positionBoxes',
    value: function positionBoxes() {
      var _this3 = this;

      var handleXOffset = -parseFloat(this.options.handleStyles.width) / 2 + 'px';
      var handleYOffset = -parseFloat(this.options.handleStyles.height) / 2 + 'px';

      var l = [{ left: handleXOffset, top: handleYOffset }, // top left
      ...
      l.forEach(function (pos, idx) {
        Object.assign(_this3.boxes[idx].style, pos);
      });
    }
  }, {
    key: 'addBox',
    ...
    value: function setCursor(value) {
      [document.body, this.vid].forEach(function (el) {
...
var Toolbar = function (_BaseModule) {
  ...
  _createClass(Toolbar, [{
    ...
    key: '_defineAlignments',
    value: function _defineAlignments() {
      var _this2 = this;

      this.alignments = [{
        icon: __WEBPACK_IMPORTED_MODULE_0_quill_assets_icons_align_left_svg___default.a,
        apply: function apply() {
          DisplayStyle.add(_this2.vid, 'inline');
          FloatStyle.add(_this2.vid, 'left');
          MarginStyle.add(_this2.vid, '0 1em 1em 0');
        },
        isApplied: function isApplied() {
          return FloatStyle.value(_this2.vid) == 'left';
        }
      }, {
        icon: __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg___default.a,
        apply: function apply() {
          DisplayStyle.add(_this2.vid, 'block');
          FloatStyle.remove(_this2.vid);
          MarginStyle.add(_this2.vid, 'auto');
        },
        isApplied: function isApplied() {
          return MarginStyle.value(_this2.vid) == 'auto';
        }
      }, {
        icon: __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg___default.a,
        apply: function apply() {
          DisplayStyle.add(_this2.vid, 'inline');
          FloatStyle.add(_this2.vid, 'right');
          MarginStyle.add(_this2.vid, '0 0 1em 1em');
        },
        isApplied: function isApplied() {
          return FloatStyle.value(_this2.vid) == 'right';
        }
      }];
    }
  }, {
    key: '_addToolbarButtons',
    value: function _addToolbarButtons() {
      var _this3 = this;

      var buttons = [];
      this.alignments.forEach(function (alignment, idx) {
        ...
        button.addEventListener('click', function () {
          ...
          if (alignment.isApplied()) {
            // If applied, unapply
            FloatStyle.remove(_this3.vid);
            MarginStyle.remove(_this3.vid);
            DisplayStyle.remove(_this3.vid);
          } else {
            // otherwise, select button and apply
            _this3._selectButton(button);
            alignment.apply();
          }
          // image may change position redraw drag handles
          _this3.requestUpdate();
        });
        Object.assign(button.style, _this3.options.toolbarButtonStyles);
        if (idx > 0) {
          button.style.borderLeftWidth = '0';
        }
        Object.assign(button.children[0].style, _this3.options.toolbarButtonSvgStyles);
        if (alignment.isApplied()) {
          // select button if previously applied
          _this3._selectButton(button);
        }
        _this3.toolbar.appendChild(button);
      });
    }
  }, {
    key: '_selectButton',
    value: function _selectButton(button) {
...
var VideoResize = function () {
  function VideoResize(quill) {
    ...
    this.checkVideo = function (evt) {
      if (_this.vid) {
        if (evt.keyCode == 46 || evt.keyCode == 8) {
          window.Quill.find(_this.vid).deleteAt(0);
        }
        _this.hide();
      }
    };
  ...
  _createClass(VideoResize, [{
    ...
    value: function initializeModules() {
      ...
      this.modules = this.moduleClasses.map(function (ModuleClass) {
        return new (knownModules[ModuleClass] || ModuleClass)(_this2);
      });
    ...
    value: function repositionElements() {
      ...
      var rect = this.vid.getBoundingClientRect();
